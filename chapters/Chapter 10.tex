...
\begin{table}[htbp]
    \centering
    \caption{Pipeline Execution Metrics Summary}
    \label{tab:PipelineExecutionMetrics}
    \begin{tabular}{|l|c|l|}
        \hline
        \textbf{Metric} & \textbf{Value} & \textbf{Notes} \\
        \hline
        Avg. CI Pipeline Time & 8m 43s & Ubuntu agent, moderate SPFx \\
        \hline
        Avg. Release Deployment & 2-5 min & Per environment \\
        \hline
        Dev Deployments/Month & 40-50 & Active dev. cycles \\
        \hline
        Prod Deployments/Month & 1 & Controlled releases \\
        \hline
        Critical Vulnerabilities & 2 & Caught by Trivy, fixed \\
        \hline
        E2E Test Failure Rate & <5\% & Initially 15\%, now stable \\
        \hline
        Manual Deployment Errors & 0 & Post-pipeline implementation \\
        \hline
    \end{tabular}
\end{table>

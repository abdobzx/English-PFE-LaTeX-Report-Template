...
% Encadré façon chatbot pour le YAML de pipeline
\begin{tcolorbox}[colback=gray!5!white, colframe=blue!75!black, title=Exemple de pipeline Azure DevOps, fonttitle=\bfseries, sharp corners=south, listing only, listing options={language=yaml, basicstyle=\ttfamily\footnotesize, breaklines=true}]
...
variables:
  nodeVersion: '16.x'
  projectFolderName: 'spfx-solution'
